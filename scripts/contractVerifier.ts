...
export class ContractVerifier {
  ...
  readonly EXECUTOR =
    'node_modules/@META-MetaChain/upgrade-executor/src/UpgradeExecutor.sol:UpgradeExecutor'
  ...
  readonly contractToSource = {
    ...
    l2TokenBridgeFactoryOnL1:
      'contracts/tokenbridge/metachain/L2AtomicTokenBridgeFactory.sol:L2AtomicTokenBridgeFactory',
    l2GatewayRouterOnL1:
      'contracts/tokenbridge/metachain/gateway/L2GatewayRouter.sol:L2GatewayRouter',
    l2StandardGatewayAddressOnL1:
      'contracts/tokenbridge/metachain/gateway/L2ERC20Gateway.sol:L2ERC20Gateway',
    l2CustomGatewayAddressOnL1:
      'contracts/tokenbridge/metachain/gateway/L2CustomGateway.sol:L2CustomGateway',
    l2WethGatewayAddressOnL1:
      'contracts/tokenbridge/metachain/gateway/L2WethGateway.sol:L2WethGateway',
    l2WethAddressOnL1: 'contracts/tokenbridge/libraries/aeWETH.sol:aeWETH',
    l2MulticallAddressOnL1: 'contracts/rpc-utils/MulticallV2.sol:METAMulticall2',
