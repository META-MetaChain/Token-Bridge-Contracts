 ...
 * This is a cute trick to allow an metachain node to provide data without us having to implement an additional RPC )
 */
...
interface NodeInterface {
     ...
     * @return l2Sender sender if original message (i.e., caller of METASys.sendTxToL1)
