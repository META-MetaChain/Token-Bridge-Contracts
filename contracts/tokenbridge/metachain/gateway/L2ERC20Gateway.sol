...
import "./L2metachainGateway.sol";
import "../StandardMETAERC20.sol";
import "../../libraries/ClonableBeaconProxy.sol";

contract L2ERC20Gateway is L2metachainGateway {
    ...
    function initialize(
        ...
        L2metachainGateway._initialize(_l1Counterpart, _router);
    ...
    function handleNoContract(
        ...
        StandardMETAERC20(createdContract).bridgeInit(l1ERC20, deployData);
