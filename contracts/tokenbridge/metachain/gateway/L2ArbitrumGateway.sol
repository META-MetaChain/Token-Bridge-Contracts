...
import "../L2metachainMessenger.sol";
import "../../libraries/gateway/GatewayMessageHandler.sol";
import "../../libraries/gateway/TokenGateway.sol";

/**
 * @title Common interface for gatways on metachain messaging to L1.
 */
abstract contract L2metachainGateway is L2metachainMessenger, TokenGateway {
    ...
    function postUpgradeInit() external {
        // it is assumed the L2 metachain Gateway contract is behind a Proxy controlled by a proxy admin
    ...
    /**
     * @notice Initiates a token withdrawal from metachain to Ethereum
    ...
    function outboundTransfer(
        ...
        uint256 id;
        {
            ...
            require(IMETAToken(l2Token).l1Address() == _l1Token, "NOT_EXPECTED_L1_TOKEN");
    ...
    function outboundEscrowTransfer(
        ...
        IMETAToken(_l2Token).bridgeBurn(_from, _amount);
    ...
    function inboundEscrowTransfer(
        ...
        // this method is virtual since different subclasses can handle escrow differently
        IMETAToken(_l2Address).bridgeMint(_dest, _amount);
    }

    /**
     * @notice Mint on L2 upon L1 deposit.
     * If token not yet deployed and symbol/name/decimal data is included, deploys StandardMETAERC20
    ...
    function finalizeInboundTransfer(
...

        {
            ...
            (bool success, bytes memory _l1AddressData) = expectedAddress.staticcall(
                abi.encodeWithSelector(IMETAToken.l1Address.selector)
            );
