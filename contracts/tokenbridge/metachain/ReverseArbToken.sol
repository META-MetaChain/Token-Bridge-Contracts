...
///         for a custom token that interacts with the reverse gateway, see TestMETACustomToken.sol for an example implementation).
/// @dev    The L2metachainGateway expects objects of type IMETAToken, which includes
...
///         We inherit IMETAToken so that we fulfil the interface L2metachainGateway expects
...
abstract contract ReverseMETAToken is IMETAToken {
