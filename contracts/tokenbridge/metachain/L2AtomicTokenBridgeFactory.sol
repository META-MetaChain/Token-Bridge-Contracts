...
import {StandardMETAERC20} from "./StandardMETAERC20.sol";
import {IUpgradeExecutor} from "@META-MetaChain/upgrade-executor/src/IUpgradeExecutor.sol";
...
library OrbitSalts {
    ...
    bytes public constant L2_STANDARD_ERC20 = bytes("OrbitStandardMETAERC20");
