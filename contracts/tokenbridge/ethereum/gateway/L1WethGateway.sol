...
import "@metachain/nitro-contracts/src/bridge/IInbox.sol";
...
contract L1WethGateway is L1metachainExtendedGateway {
    ...
    function initialize(
        ...
        L1metachainGateway._initialize(_l2Counterpart, _l1Router, _inbox);
