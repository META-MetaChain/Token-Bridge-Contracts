...
/**
 * @title Common interface for gatways on L1 messaging to metachain.
 */
abstract contract L1metachainGateway is
    ...
    IL1metachainGateway
{
    ...
    function postUpgradeInit() external {
        // it is assumed the L1 metachain Gateway contract is behind a Proxy controlled by a proxy admin
    ...
    function getExternalCall(
        ...
        // using tradeable exits in a subclass (L1metachainExtendedGateway)
    ...
    /**
     * @notice Deposit ERC20 token from Ethereum into metachain. If L2 side hasn't been deployed yet, includes name/symbol/decimals data for initial L2 deploy. Initiate by GatewayRouter.
