...
import "./L1metachainExtendedGateway.sol";
import "../../metachain/gateway/L2CustomGateway.sol";
 ...
 */
contract L1CustomGateway is L1metachainExtendedGateway, ICustomGateway {
    ...
    function initialize(
        ...
        L1metachainGateway._initialize(_l1Counterpart, _l1Router, _inbox);
        owner = _owner;
