...
import { L1metachainExtendedGatewayTest, InboxMock, TestERC20 } from "./L1metachainExtendedGateway.t.sol";
import "contracts/tokenbridge/ethereum/gateway/L1ERC20Gateway.sol";
import "@openzeppelin/contracts/token/ERC20/ERC20.sol";

contract L1ERC20GatewayTest is L1metachainExtendedGatewayTest {
    // gateway params
    ...
    function test_getOutboundCalldata() public {
        ...
        bytes memory expectedCalldata = abi.encodeWithSelector(
            ...
            355,
            abi.encode(
                abi.encode(abi.encode("IntMETATestToken"), abi.encode("IMETA"), abi.encode(18)),
                abi.encode("doStuff()")
            )
        );
