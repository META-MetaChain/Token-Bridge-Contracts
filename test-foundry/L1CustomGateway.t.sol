...
import { L1metachainExtendedGatewayTest } from "./L1metachainExtendedGateway.t.sol";
import { L1CustomGateway, IInbox, ITokenGateway, IERC165, IL1metachainGateway, IERC20 } from "contracts/tokenbridge/ethereum/gateway/L1CustomGateway.sol";
import { L2CustomGateway } from "contracts/tokenbridge/metachain/gateway/L2CustomGateway.sol";
import { TestERC20 } from "contracts/tokenbridge/test/TestERC20.sol";
import { InboxMock } from "contracts/tokenbridge/test/InboxMock.sol";

contract L1CustomGatewayTest is L1metachainExtendedGatewayTest {
    // gateway params
    ...
    function test_calculateL2TokenAddress(address l1Token, address l2Token) public virtual {
        ...
        vm.mockCall(
            address(l1Token),
            abi.encodeWithSignature("ismetachainEnabled()"),
    ...
    function test_registerTokenToL2_revert_NotMETAEnabled() public virtual {
        // wrong answer
        vm.mockCall(
            address(token),
            abi.encodeWithSignature("ismetachainEnabled()"),
        ...
        vm.prank(address(token));
        vm.expectRevert("NOT_META_ENABLED");
        L1CustomGateway(address(l1Gateway)).registerTokenToL2{ value: retryableCost }(
            address(102),
            maxGas,
            gasPriceBid,
