...
import { abi as UpgradeExecutorABI } from '@META-MetaChain/upgrade-executor/build/contracts/src/UpgradeExecutor.sol/UpgradeExecutor.json'
...
describe('tokenBridge', () => {
  it('should have deployed and initialized token bridge contracts', async function () {
    ...
    await checkL2MulticallInitialization(
      METAMulticall2__factory.connect(l2.multicall, l2Provider)
    )
...
async function checkL2MulticallInitialization(l2Multicall: METAMulticall2) {
